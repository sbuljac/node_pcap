...
TCP.prototype.decode = function(raw_packet, offset, len) {
    ...
    if (this.dataLength > 0) {
      ...
      // console.log(raw_packet.toString('utf-8', offset, offset + 4));
        var ProtocolDecoder = protocols[raw_packet.toString('utf-8', offset, offset + 4)];
